...
def load_parameters():
    ...
    # Input data params
    TASK_NAME = 'demo'                           # Task name.
    DATASET_NAME = TASK_NAME                        # Dataset name.
    SRC_LAN = 'original'                                  # Language of the source text.
    TRG_LAN = 'updated'                                  # Language of the target text.
    DATA_ROOT_PATH = '/opt/nmt-keras/dataset/'  # Path where data is stored.
    ...
    USE_TF_OPTIMIZER = False                       # Use native Tensorflow's optimizer (only for the Tensorflow backend).
    ...
    PATIENCE = 30                                 # We'll stop if the val STOP_METRIC does not improve after this.
    ...
    STORE_PATH = '/opt/nmt-keras/models/new/'  # Models and evaluation results will be stored here.
    DATASET_STORE_PATH = '/opt/nmt-keras/dataset/'                   # Dataset instance will be stored here.
